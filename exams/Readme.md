...
**Загальна кількість завдань:** ~148 завдань з 15 лабораторних робіт
...
# Lab-11 — Узагальнене програмування та функції з continue
...
Цей збірник містить **148 завдань** з **15 лабораторних робіт** курсу "Fundamentals of Programming 2025-26". Завдання охоплюють:

- **Основи програмування**: введення/виведення, умови, цикли
- **Функції**: параметри, посилання, шаблони
- **Структури даних**: масиви, рядки, матриці
- **ООП**: класи, інкапсуляція, наслідування, поліморфізм
- **Управління пам'яттю**: динамічна пам'ять, RAII, Rule of Three

Використовуйте цей збірник для систематичної підготовки до іспитів та контрольних робіт!
